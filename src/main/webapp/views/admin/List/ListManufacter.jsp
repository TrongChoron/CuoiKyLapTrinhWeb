...
<html>
    <head>
        ...
        <title><fmt:message key="label.manufacter" bundle="${lang}"/></title>
    </head>
    <body>
                ...
                <div class="breadcrumb" id="breadcrumbs">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li style="margin-left: 10px">
                            ...
                            <fmt:message key="label.manufacter" bundle="${lang}"/>
                        </li>
                    </ul>
                </div>
                <form id="formsubmit" action="<c:url value='/admin-manufacter'/>" method="get">
